...
=============================================================================
This file (originally `models.py`) was downloaded from the official PANNs 
(Pretrained Audio Neural Networks) repository. It has been renamed to 
`panns_models.py` and may contain minor modifications for compatibility with 
this specific project pipeline.

Original Repository: https://github.com/qiuqiangkong/audioset_tagging_cnn
Original Authors: Qiuqiang Kong, Yin Cao, Turab Iqbal, Yuxuan Wang, 
