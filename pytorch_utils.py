...
=============================================================================
This file was downloaded directly from the official PANNs (Pretrained Audio 
Neural Networks) repository to serve as a dependency for the PANNs ResNet38 
architecture. It is not the original work of this project's author.

Original Repository: https://github.com/qiuqiangkong/audioset_tagging_cnn
Original Authors: Qiuqiang Kong et al.
=============================================================================
"""
